...
API_ID = int(environ['API_ID'] = "20489840"
API_HASH = environ['API_HASH'84e42582165ad1c99823bc4e910eefe7]
BOT_TOKEN = environ['BOT_TOKEN'] = "7769111593:AAEX_EtCqUVjz9Zd-7lYsHXgjW4akjLzL3w"
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7517497308').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002349889700').split()]
...
# MongoDB information *
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://shivak51886:zULruPl5bx507OvN@cluster0.tkp78.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "LazyDeveloper")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# LOG CHANNELS *
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002307807953))
